...
const baseProducts: Product[] = [
  ...
  { id: 37, image: '/salsas-de-tomate/SalsaKetchup-Heinz397gr-(16undplástico)-caja.png', hoverImage: '/salsas-de-tomate/SalsaKetchup-Heinz397gr-(16undplástico)-unidad.png', brand: 'Heinz', name: 'Salsa Ketchup Heinz 397gr (16und plástico) - Caja', price: 38.98, category: 'Salsas' },
  ...
  { id: 40, image: '/salsas-de-tomate/Ketchup-Doña-Nelly(5und x 4KG)-caja.png', hoverImage: '/salsas-de-tomate/Ketchup-Doña-Nelly(5und x 4KG)-unidad.png', brand: 'Doña Nelly', name: 'Ketchup Doña Nelly (5und x 4KG) - Bulto', price: 17.06, category: 'Salsas' },
  ...
  { id: 42, image: '/salsas-de-tomate/Salsa-Ketchup-La-Viña-(1KG x 6 Bolsa)-caja.png', hoverImage: '/salsas-de-tomate/Salsa-Ketchup-La-Viña-(1KG x 6 Bolsa)-unidad.png', brand: 'La Viña', name: 'Salsa Ketchup La Viña (1KG x 6 Bolsa) - Bulto', price: 16.32, category: 'Salsas' },
  { id: 43, image: '/salsas-de-tomate/Salsa-Base-TomaticoViña-(4x4)-caja.png', hoverImage: '/salsas-de-tomate/Salsa-Base-TomaticoViña-(4x4)-unidad.png', brand: 'La Viña', name: 'Salsa Base Tomatico Viña (4x4) - Bulto', price: 17.24, category: 'Salsas' },
  { id: 44, image: '/salsas-de-tomate/Salsa-de-Tomate-Paraíso(4x4)-caja.png', hoverImage: '/salsas-de-tomate/Salsa-de-Tomate-Paraíso(4x4)-unidad.png', brand: 'Paraíso', name: 'Salsa de Tomate Paraíso (4x4) - Bulto', price: 17.05, category: 'Salsas' },
  ...
  { id: 48, image: '/salsas-de-tomate/Salsa-Coma-Ketchup-Plástico (4x4)-caja.png', hoverImage: '/salsas-de-tomate/Salsa-Coma-Ketchup-Plástico (4x4)-unidad.png', brand: 'Coma', name: 'Salsa Coma Ketchup Plástico (4x4) - Bulto', price: 47.18, category: 'Salsas' },
